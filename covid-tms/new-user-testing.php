...
$query="insert into tblpatients(FullName,MobileNumber,DateOfBirth,GovtIssuedId,GovtIssuedIdNo,FullAddress,Province) values('$fname','$mnumber','$dob','$govtid','$govtidnumber','$address','$province');";
...
<head>
    ...
    <title>CoviMed | New User Testing</title>
...
<form name="newtesting" method="post">
 ...
 <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="province" name="province" placeholder="Enter your Province Here" required="true">
                                        </div>
